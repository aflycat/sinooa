        ...
        <Card  class="itemCard">
             ...
             <Card  class="itemCard">
                ...
                <Form :label-width="80">
                    ...
                    <Row>
                        <Col span="8">
                            <FormItem label="协议金额" prop="ProjectEstimatedHourCost">
                                <Input  type="number" placeholder="请输入协议金额">
                                      <span slot="append">万元</span>
                                </Input>
                            </FormItem>   
                        </Col>
                          <Col span="8">
                            <FormItem label="费用性质" prop="ProjectEstimatedHourCost">
                                <Input placeholder="请输入费用性质">
                         ...
                         <Col span="8">
                            <FormItem label="支付方式" prop="ProjectEstimatedHourCost">
