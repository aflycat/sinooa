    ...
    data(){
        return{
           ...
           ProjectVlaue:'',
            ...
            postdata:{
                    TaskTypeID:TaskTypeID.itemChange,//任务类别ID，与TaskTypes表的TaskTypeID对应（开发3/立项4/变动5），取自对应的菜单项
            ...
            selectProDetail(){
                 getProjectDetail({ProjectID:this.ProjectVlaue}).then(res=>{
                    if(res.data.code==2307){
                        ...
                        res=res.data;
                        this.postdata={
                                TaskTypeID:5,//任务类别ID，与TaskTypes表的TaskTypeID对应（开发3/立项4/变动5），取自对应的菜单项
                                Client:{
