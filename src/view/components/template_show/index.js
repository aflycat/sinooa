import opraTem from "./opra.vue" //公司运营审批
import fundedictTem from "./fund_edict.vue" //基金项目开发。立项，变动审批
import fundshowTem from "./fund_show.vue" //基金项目
import progedictTem from "./prog.vue" //项目开发，立项，变动
import progshowTem from "./prog.vue" //项目
import definExcel from "./defin_excel.vue" //自定义流程审批

import costField from "./cost_field.vue"
import costEntertain from "./cost_entertain.vue"
import costWage from "./cost_wage.vue"
import costProgram from "./cost_program.vue"
import costTrain from "./cost_train.vue"
import costGeneral from "./cost_general.vue" //自定义流程审批

import costFieldShow from "./cost_field_show.vue"
import costEntertainShow from "./cost_entertain_show.vue"
import costWageShow from "./cost_wage_show.vue"
import costProgramShow from "./cost_program_show.vue"
import costTrainShow from "./cost_train_show.vue"
import costGeneralShow from "./cost_general_show.vue" //自定义流程审批

export default opraTem
export default fundedictTem
export default fundshowTem
export default progedictTem
export default progshowTem
export default definExcel

export default costField
export default costEntertain
export default costWage
export default costProgram
export default costTrain
export default costGeneral

export default costFieldShow
export default costEntertainShow
export default costWageShow
