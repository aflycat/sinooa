                    ...
                    <Row>
                        <Col span="8">
                            <FormItem label="招待人数" prop="name">
                                <Input  v-model="name" type="number" placeholder="请输入招待人数"></Input>
                            </FormItem>
                        </Col>
                         <Col span="8">
                            <FormItem label="招待时间" prop="phone">
                                <Input v-model="phone" placeholder="请输入招待时间"></Input>
                            </FormItem>   
                        </Col>

                         <Col span="8">
                             <FormItem label="活动费用" prop="phone">
                                <Input v-model="phone" type="number" placeholder="请输活动费用"></Input>
                            </FormItem>   
                        </Col>
                         <Col span="8">
                            <FormItem label="礼品费用" prop="phone">
                                <Input v-model="phone" type="number" placeholder="请输入礼品费用"></Input>
                            </FormItem>   
                        </Col>
                         <Col span="8">
                            <FormItem label="餐费" prop="phone">
                                <Input v-model="phone" type="number" placeholder="请输入餐费"></Input>
                            </FormItem>   
                        </Col>
                         <Col span="8">
