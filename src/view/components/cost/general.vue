                    ...
                    <Row>
                        <Col span="8">
                            <FormItem label="时间" prop="phone">
                                <Input v-model="phone" placeholder="请输入时间"></Input>
                            </FormItem>   
                        </Col>
                        <Col span="8">
                        ...
                        <Col span="8">
                         ...
                         <Col span="8">
                             <FormItem label="固定资产支出" prop="phone">
                                <Input v-model="phone" type="number" placeholder="请输入固定资产支出"></Input>
                            </FormItem>   
                        </Col>
                         <Col span="8">
                            <FormItem label="律师费" prop="phone">
                                <Input v-model="phone" type="number" placeholder="请输入律师费"></Input>
                            </FormItem>   
                        </Col>
                         <Col span="8">
                             <FormItem label="车辆费" prop="phone">
                                <Input v-model="phone" type="number" placeholder="请输入车辆费"></Input>
                            </FormItem>   
                        </Col>
                         <Col span="8">
